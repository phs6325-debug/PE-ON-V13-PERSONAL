...
// (readExcelRows/getExcelCell/inferClassNameFromRow/extractNeisClassAndNumber/parseScoreNumber/findAnyScoreValue/findColumnValueForItem
// 로직은 src/utils/assessmentScoreImport.js 로 이동해 관리 탭과 공유합니다.)
  ...
  const handleAssessmentScoreUpload = async (event) => {
    ...
    try {
      const { nextScores, imported, skipped, rowCount } = await importAssessmentScores({
        ...
        targetActivityId: inputActivityId,
        fallbackClass: scoreClass,
      });
